export function generateNewOrderNotificationEmail(
  ...
  const displayName = buyerName || 'Un usuario';
  return `
  <div style="font-family: Arial, sans-serif; color: #4b5563; max-width: 650px; margin: auto; border: 1px solid #e5e7eb; border-radius: 10px; overflow: hidden; font-size: 16px;">
    ...
    <div style="width: 100%; text-align: center;">
      <img src="https://res.cloudinary.com/majomon/image/upload/v1759158767/FotoNube/Imagenes%20para%20los%20Emails/banner-FOTONUBE-Mail_Bienvenida_Compradores_oe4imx.jpg" alt="Nuevo pedido" style="width: 100%; height: auto; display: block;" />
    </div>
    ...
    <div style="padding: 25px 40px; background-color: #ffffff;">
      ...
      <p style="font-size: 17px; line-height: 1.6; color: #4b5563; text-align: center; margin-bottom: 25px;">
        ${displayName} ha realizado una compra de ${itemCount} fotos por un total de $${total}.
      </p>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://next-foto-nube.vercel.app/dashboard/orders/${orderId}" 
